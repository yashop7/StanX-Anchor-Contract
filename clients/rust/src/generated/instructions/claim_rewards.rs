...
impl ClaimRewards {
  pub fn instruction(&self, args: ClaimRewardsInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ClaimRewardsInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = ClaimRewardsInstructionData::new().try_to_vec().unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ClaimRewardsInstructionArgs {
                  pub market_id: u32,
      }

impl ClaimRewardsInstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
...
///
          ...
          ///   3. `[]` collateral_mint
                ...
                ///   5. `[writable]` collateral_vault
                ///   6. `[writable]` outcome_yes_mint
                ///   7. `[writable]` outcome_no_mint
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = ClaimRewards {
          ...
          let args = ClaimRewardsInstructionArgs {
...
pub struct ClaimRewardsCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: ClaimRewardsInstructionArgs,
  }
